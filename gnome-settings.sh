...
gsettings set org.gnome.desktop.wm.keybindings begin-resize "['<Super>s']";
...
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-left "['<Shift><Super>r', '<Shift><Super>Left']";
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-right "['<Shift><Super>f', '<Shift><Super>Right']";
...
gsettings set org.gnome.desktop.wm.keybindings show-desktop "['<Super>c']";
...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-left "['<Control><Super>r', '<Control><Super>Left']";
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-right "['<Control><Super>f', '<Control><Super>Right']";
...
gsettings set org.gnome.mutter.keybindings toggle-tiled-left "['<Super>r', '<Super>Left', '<Super>KP_4']";
gsettings set org.gnome.mutter.keybindings toggle-tiled-right "['<Super>f', '<Super>Right', '<Super>KP_6']";
